...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    GOLD("g_anillo_armor", 7, new int[]{1, 3, 5, 2}, 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 0.0F, 0.0F, () -> {
        return Ingredient.of(Items.GOLD_INGOT);
    }),
    DIAMOND("d_anillo_armor", 7, new int[]{1, 3, 5, 2}, 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 0.0F, 0.0F, () -> {
        return Ingredient.of(Items.GOLD_INGOT);
    });
